...
public class Chapathi extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        if(quantity == 0){
            ...
            OrderDataBase.execSQL("INSERT INTO orders VALUES('" + Name + "','Chapathi','" + quantity + "','"+ FinalPrice+"' );");
            Message += "Name   :  " + Name;
            Message += "\nDetails: Order for " + quantity + " plates of Chapathi";
    ...
    public void addMore(View view){
        Intent intent = new Intent(Chapathi.this, AddMore.class);
