...
public class MasalaDosa extends AppCompatActivity {
    ...
    public void submitOrder(View view) {
        if(quantity == 0){
            ...
            OrderDataBase.execSQL("INSERT INTO orders VALUES('" + Name + "','Masala Dosa','" + quantity + "','" + FinalPrice+"' );");
            Message += "Name   :  " + Name;
            Message += "\nDetails: Order for " + quantity + " plates of Masala Dosa";
    ...
    public void addMore(View view){
        Intent intent = new Intent(MasalaDosa.this, AddMore.class);
