...
public class PlainDosa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plain_dosa);
    ...
    public void submitOrder(View view) {
        if(quantity == 0){
            ...
            OrderDataBase.execSQL("INSERT INTO orders VALUES('" + Name + "','Plain Dosa','" + quantity + "', '" + FinalPrice + "' );");
            Message += "Name   :  " + Name;
            Message += "\nDetails: Order for " + quantity + " plates of Plain Dosa";
    ...
    public void addMore(View view){
        Intent intent = new Intent(PlainDosa.this, AddMore.class);
