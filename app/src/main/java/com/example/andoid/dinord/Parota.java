...
public class Parota extends AppCompatActivity {
    String Name = "";
    int quantity = 0;
    int FinalPrice = 0;
    String Message = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parota);
    ...
    public void submitOrder(View view) {
        if (quantity == 0) {
            ...
            OrderDataBase.execSQL("INSERT INTO orders VALUES('" + Name + "','Parota','" + quantity + "' , '"+FinalPrice+"' );");
            Message += "Name   :  " + Name;
            Message += "\nDetails: Order for " + quantity + " plates of Parota";
    ...
    public void addMore(View view){
        Intent intent = new Intent(Parota.this, AddMore.class);
